 ...
 */
public class SalleDuTrone extends Merveille{
    public SalleDuTrone() {
        super("salle du trone", 6, "chaque fois que la courane passe d'un joueur a un autre, vous recevez une piece d'or de la banque");
    }
